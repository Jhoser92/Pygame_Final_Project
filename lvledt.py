...
blob_img = pygame.image.load('img/world1/enemy.png')
platform_x_img = pygame.image.load('img/world1/platform_x.png')
platform_y_img = pygame.image.load('img/world1/platform_y.png')
lava_img = pygame.image.load('img/world1/spikes.png')
coin_img = pygame.image.load('img/rupee.png')
		...
		for col in range(20):
			if world_data[row][col] > 0:
				...
				if world_data[row][col] == 9:
					#dirt blocks
					img = pygame.transform.scale(bdr_img, (tile_size, tile_size))
					screen.blit(img, (col * tile_size, row * tile_size))
